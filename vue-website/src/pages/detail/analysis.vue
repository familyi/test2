<template>
  <div class="sales-board">
	...
	<my-dialog :is-show="isShowPayDialog" @on-close="hidePayDialog">
      ...
      <check-order @on-close-check-dialog="hideCheckDialog" :order-id="orderId" :is-show-check-dialog="isShowCheckOrder" :is-show-err-dialog="isShowErrOrder"></check-order>
...
import MyDialog from '../../components/base/diolog'
